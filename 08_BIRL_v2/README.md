...
All computation runs on Rorqual (Alliance Canada; account `def-zhiming_gpu`,
project root `/scratch/jsentang/birl_v2`) through the `slurm/` package; see
...
```bash
bash slurm/sync_up.sh          # code + the three 06 data files -> /scratch/jsentang/birl_v2
